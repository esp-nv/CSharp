...
//input
double percentSneakers = 40;
double percentEquipment = 20;
double ballPrice = 1/4.0; //double ballPrice = 0.25;
double accessoriesPrice = 0.2; //double accessoriesPrice = 1/5.0;
int yearPrice = int.Parse(Console.ReadLine());

//calculate
double sneаkers = yearPrice - (yearPrice * percentSneakers / 100);
double equipment = sneаkers - (sneаkers*percentEquipment/100);
double ball= equipment * ballPrice;
double accessories = ball * accessoriesPrice;
double totalSum = yearPrice + sneаkers + equipment+ball+ accessories;
