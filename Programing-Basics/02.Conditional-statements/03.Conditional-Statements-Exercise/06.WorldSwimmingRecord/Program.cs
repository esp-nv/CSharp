////06. World Swimming Record Световен рекорд по плуване
...
//Да се изчисли времето в секунди, за което Иванчо
//ще преплува разстоянието и разликата спрямо Световния рекорд. 
//Вход
...
double swimInMeters = double.Parse(Console.ReadLine());
double timePerMeter=double.Parse(Console.ReadLine());

//calculate
double swimWithoutDelay = swimInMeters * timePerMeter;
double swimWithDelay = Math.Floor(swimInMeters / 15) ;
double totalTime=swimWithoutDelay + swimWithDelay *12.5;
...
{
    double delayTime = totalTime - recordInSeconds;

    Console.WriteLine($"No, he failed! He was {delayTime:f2} seconds slower.");
}